...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[L]{{\footnotesize\textsc{List \# {6}}}}
...
\textarabic{من يعتقد أن ناصر اشترى البيت؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يعرف ما إذا كانت مروة لاحقت الحافلة؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تدّعي أن الأصدقاء تبادلوا في السوق؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يعتقد الشرطي أن محمود سرقه؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تشتكي إذا عزفه الموسيقيّ في الحفل؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا سمعتَ أن ميرا حضّرته؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا سمعتَ أن إلياس أخذ؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يشكّ أن الملك كتب خطابا طويلا بالأمس؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من أنكر الحقيقة أن احمد أكل اللحم؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يظنّ المعلم أن نور قرأت؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من زعم أن علي سرق المال؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يضحك إذا اشترى الامير سجادة في السوق؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يتساءل المدير ما إذا كانت منى باعت؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تخجل إذا رسم الفنان اليوم؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يعرف الجندي ما إذا كان مصطفى كتبه؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا أعلنتَ الخبر أن عصام ربح؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا أعلنتَ الخبر أن فاطمة خسرته؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تعتقد أن المحامي نسيه في المكتب؟}
\end{flushright}
