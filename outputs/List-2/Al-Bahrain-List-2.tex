...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[L]{{\footnotesize\textsc{List \# {2}}}}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا أعلنتَ أن عصام ربحه؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تعتقد أن الفنان سيرسمه اليوم؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يعرف المعلم ما إذا كانت نور قرأته؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يعرف ما إذا كان مصطفى كتب الرسالة؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا أنكرتَ أن احمد أكل؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من سمع أن ميرا حضّرت الخبز؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تظنّ المحققة أن مروة لاحقت؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يعتقد المدير أن منى باعته؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تفرح إذا تبادله الأصدقاء في السوق؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يشتكي إذا عزف الموسيقيّ أغنيته الجديدة في الحفل؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يعتقد أن محمود سرق المحفظة؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تتمنى أن الامير اشترى في السوق؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من يعتقد أن المحامي نسي حقيبته في المكتب؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا نشرتَ الادعاء أن علي سرق؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا سمعتَ الإشاعة أن إلياس أخذه؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا يتساءل المصرفي ما إذا كان ناصر اشترى؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{من أعلن الخبر أن فاطمة خسرت المباراة؟}
\end{flushright}
...
\vspace{0.5\baselineskip}\begin{flushright}
\textarabic{ماذا تضحك إذا كتب الملك بالأمس؟}
\end{flushright}
